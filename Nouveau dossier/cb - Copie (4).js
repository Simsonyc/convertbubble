(function () {
  ...
  function openOverlay(config, wrapper) {
    ...
    // ------- VIDÉO : corrections MINIMALES pour afficher la barre -------
    // Problèmes constatés : overflow hidden + hauteur forcée rognaient la barre.
    // Fix : pas de height forcé, pas de flex sur le conteneur, pas de clipping,
    // et on réserve un léger espace en bas pour la barre si le navigateur la peint au bord.
    ...
    const videoWrap = el("div", {
      ...
      background:"#000",
      borderRadius:"10px",
      overflow:"visible",        // 👈 ne pas couper la barre
      display:"block",
      paddingBottom:"40px"       // 👈 espace pour la barre (sécurise Chrome/Edge)
    });
    ...
    Object.assign(video.style, {
      ...
      borderRadius:"10px",
      objectFit:"contain",
      maxHeight:"calc(90vh - 200px)" // reste dans l'overlay même en paysage
    });
    video.controls = true;
    ...
    // CTA (inchangé, mais décalé pour ne pas recouvrir la barre)
